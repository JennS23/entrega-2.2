...
from Red_instagram.views.ventana_feed import VentanaFeed
from Red_instagram.views.ventana_inicio_sesion import VentanaInicioSesion
from Red_instagram.views.ventana_registro import VentanaRegistro
from Red_instagram.models.red_social import RedSocial
